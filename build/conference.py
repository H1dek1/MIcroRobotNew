...
#        return all_potential
    ...
    def init():
        ...
        ax1.add_patch(perm1)
        ax1.quiver(perm1_x[0], perm1_y[0], perm1_u[0], perm1_v[0], color='black', angles='xy', scale_units='xy', scale=1.2, pivot='mid', width=1.0e-2, zorder=3)
    ...
    def update(i):
        ...
        ax1.add_patch(perm1)
        ax1.quiver(perm1_x[i], perm1_y[i], perm1_u[i], perm1_v[i], color='black', angles='xy', scale_units='xy', scale=1.2, pivot='mid', width=1.0e-2, zorder=3)
